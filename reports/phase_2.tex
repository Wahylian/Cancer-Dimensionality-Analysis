...
\midrule
0.100 & 17.83 & 356 & 686 & 531.70 \\
0.010 & 1.34  & 5   & 457 & 25.57 \\
0.001 & 4.63  & 5   & 5   & 5.28 \\
\bottomrule
\end{tabular}
\end{table}
...
Gaussian Noise   & 49.02 & 0.998 & 688 & 742 & 788 & 656.95 & 618.75 & 582.36 \\
Linear Manifold  & 4.63  & 1.000 & 5   & 5   & 5   & 5.44   & 5.28   & 5.09 \\
\bottomrule
\end{tabular}
\end{table}
...
variation. The curvature elbow at component $2$ reflects only the single
steepest initial drop (between PC1 and PC2) and clearly under-counts;
the Kaiser elbow at $100$ is the more defensible summary of "components
carrying above-average signal," though still well above $D_2$ and the
$k$-NN MLE estimates, for reasons discussed in Section~\ref{sec:discussion}.
